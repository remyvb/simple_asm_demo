...
# on node 1 can access like himself on node 2
#
# === Parameters
# name  - User name
...
#
define profile::oradb::user_equivalence(
  String            $private_key,
  Array[String[1]]  $nodes        = ['localhost'],
  String            $ssh_module   = lookup('profile::oradb::user_equivalence::ssh_module', String, 'deep', 'ssh_access'),
)
{
  #
  # Validate input
